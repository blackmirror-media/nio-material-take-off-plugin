...
release_base="https://github.com/blackmirror-media/nio-material-take-off-plugin/releases/download/$version"
...
case "$(uname -s)-$(uname -m)" in
  ...
  Linux-aarch64|Linux-arm64)
                       platform="linux-arm64";  artifact="mto-linux-arm64" ;;
  Linux-x86_64)        platform="linux-x64";    artifact="mto-linux-x64" ;;
  *)
