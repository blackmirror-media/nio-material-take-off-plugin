...
|-----------------------|---------------------------------------|----------------------------------------------------------------|
| `ifc.schema.not_ifc4` | IFC version is IFC4                   | https://material-take-off.com/help/ifc-export-version |
| `material.missing`    | All elements have a material assigned | https://material-take-off.com/help/ifc-materials      |
| `quantity.missing`    | BaseQuantities are exported           | https://material-take-off.com/help/ifc-basequantities |
| `element.proxy`       | No IfcBuildingElementProxy elements   | https://material-take-off.com/help/ifc-proxy-elements |
| `units.unknown`       | All quantities use recognized units   | https://material-take-off.com/help/ifc-units          |
...
> - ⚠️ **IFC version:** Re-export from your CAD tool with IFC4 selected.
    See [help article](https://material-take-off.com/help/ifc-export-version).
> - ⚠️ **Materials assigned:** Some elements have no material. In Revit, check
    the Material parameter on the family type.
    See [help article](https://material-take-off.com/help/ifc-materials).
> - ⚠️ **BaseQuantities exported:** Enable "Export base quantities" in the IFC
    export settings.
    See [help article](https://material-take-off.com/help/ifc-basequantities).
>
...
- Help URLs live at https://material-take-off.com/help/ — confirm individual
  slugs against the published site before relying on a specific link.
